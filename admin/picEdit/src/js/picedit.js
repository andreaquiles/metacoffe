    ...
    Plugin.prototype = {
        ...
        set_loading: function (message) {
            if (message && message == 1) {
                return this.set_messagebox("Executando...", false, false);
            } else
                return this.set_messagebox("Aguarde...", false, false);
        },
        ...
        camera_open: function () {
            ...
            if (!browserUserMedia)
                return this.set_messagebox("Desculpe, seu browser não suporta WebRTC!");
            var _this = this;
            ...
            getUserMedia({
                ...
                video: true
                    ...
                    function (err) {
                        return _this.set_messagebox("Nenhuma fonte de vídeo detectada! Por favor, permita o acesso à câmera!");
                    }
            );
        },
        ...
        _hideAllNav: function (message) {
            if (message && message == 1) {
                this.set_messagebox("Carregue uma imagem or use a camera para fazer a foto!");
            }
            ...
            if (!window.FormData)
                ...
                this.set_loading().delay(200).promise().done(function () {
                    ...
                    request.onprogress = function (e) {
                        ...
                        if (progress > 100)
                            progress = 100;
                        _this.set_messagebox("Aguarde... Uploading... " + progress + "% Uploaded.", false, false);
                    };
                    ...
                    request.onload = function (e) {
                        ...
                        if (data.status != 1) {
                            //if (this.status != 200) {
                            _this.set_messagebox(data.msg);
                        } else {
                            if (_this.options.redirectUrl === true) {
                                window.location.reload();
                            } else if (_this.options.redirectUrl) {
