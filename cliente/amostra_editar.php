...
try {
    ...
    if ($data) {
        ...
        if (empty($data['n_lote'])) {
            ...
            $response['error_input'][] = 'data_expiracao';
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group col-sm-12">
                                <div class="radio pull-left" >
                                    <label>
                                        <input type="radio" value="arabica"  name="tipo" checked><span style="font-size: 14px;" class="label label-default">Arábica</span>
                                    </label>
